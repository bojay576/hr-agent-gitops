...
render_manifest() {
    ...
    sed -e "s|storageClassName: openebs-hostpath|storageClassName: ${storage_class}|g" \
        -e "s|namespace: mcp-services|namespace: ${NAMESPACE}|g" \
        -e "s|name: mcp-services|name: ${NAMESPACE}|g" \
